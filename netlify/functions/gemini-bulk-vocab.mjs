        ...
        responseSchema: {
          ...
          items: {
            ...
            properties: {
              ...
              meaning: { type: Type.STRING, description: "A short definition of the word written ENTIRELY in Bahasa Indonesia (Indonesian). NEVER write this field in English. Example: for 'Desk', write something like 'Sebuah perabot dengan permukaan rata untuk menulis atau bekerja.'" },
